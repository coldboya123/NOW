package com.example.now.View.ShopView.TabView.Comment.view;
...
import com.example.now.View.ShopView.TabView.Comment.adapter.RCV_Comment_Adapter;
...
public class ShopCommentFragment extends Fragment {
    ...
    private float getTotalRate(List<Comment> list){
        ...
        return (float) (Math.round((totalRate/list.size())*10.0)/10.0);
    }
