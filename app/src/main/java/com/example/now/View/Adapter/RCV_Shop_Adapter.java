package com.example.now.View.Adapter;
...
public class RCV_Shop_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<Shop> list;
    private final int ITEMVIEW = 0, LOADINGVIEW = 1;

    public RCV_Shop_Adapter(List<Shop> list) {
        this.list = list;
    }
