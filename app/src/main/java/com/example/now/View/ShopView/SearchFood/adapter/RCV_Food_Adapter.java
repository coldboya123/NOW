package com.example.now.View.ShopView.SearchFood.adapter;
...
import com.example.now.View.ShopView.module.onSelectFood;
...
public class RCV_Food_Adapter extends RecyclerView.Adapter<RCV_Food_Adapter.ViewHolder> {
    ...
    private onSelectFoodSearch onSelectFoodSearch;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull @NotNull View itemView) {
            ...
            blockFood.setOnClickListener(v -> {
                ...
                if (onSelectFoodSearch != null){
                    Log.d("bbb", "ViewHolder: 1");
                    onSelectFoodSearch.onSelectFood(list.get(getAdapterPosition()));
                }
            });
    ...
    public void setOnSelectFoodSearchListener(onSelectFoodSearch onSelectFoodSearchListener){
        this.onSelectFoodSearch = onSelectFoodSearchListener;
    }
